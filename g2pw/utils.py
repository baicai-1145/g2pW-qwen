...
def load_qwen3_config():
    """Load Qwen3-specific configuration."""
    import os
    config_path = os.path.join(os.path.dirname(__file__), '..', 'configs', 'config_qwen3.py')
    return _load_config(config_path)


def get_model_config(config_name='cpp'):
    """
    Get model configuration by name.

    Args:
        config_name: Configuration name ('cpp', 'qwen3', etc.)
    ...
    if config_name == 'qwen3':
        config_path = os.path.join(os.path.dirname(__file__), '..', 'configs', 'config_qwen3.py')
    elif config_name == 'cpp':
        config_path = os.path.join(os.path.dirname(__file__), '..', 'configs', 'config_cpp.py')
    else:
        # Try to find config file
        config_path = os.path.join(os.path.dirname(__file__), '..', 'configs', f'config_{config_name}.py')
